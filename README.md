...
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <a href="https://github.com/SimformSolutionsPvtLtd/SSJetPackComposeProgressButton/blob/main/app/src/main/java/com/simform/ssjetpackcomposeprogressbutton/MainActivity.kt" target="_blank"><img src="/gif/success.gif" height="850px"/></a> | <a href="https://github.com/SimformSolutionsPvtLtd/SSJetPackComposeProgressButton/blob/main/app/src/main/java/com/simform/ssjetpackcomposeprogressbutton/MainActivity.kt" target="_blank"><img src="/gif/failure.gif" height="850px"/></a> |

# 🎬 Customized loading animation

| On Success                                                                                                                                                                                                                                        | On Failure                                                                                                                                                                                                                                     |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <a href="https://github.com/SimformSolutionsPvtLtd/SSJetPackComposeProgressButton/blob/main/app/src/main/java/com/simform/ssjetpackcomposeprogressbutton/MainActivity.kt" target="_blank"><img src="/gif/custom_success.gif" height="450px"/></a> | <a href="https://github.com/SimformSolutionsPvtLtd/SSJetPackComposeProgressButton/blob/main/app/src/main/java/com/simform/ssjetpackcomposeprogressbutton/MainActivity.kt" target="_blank"><img src="/gif/custom_fail.gif" height="450px"/></a> |
